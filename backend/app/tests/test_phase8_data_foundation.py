...
def test_phase8_migration_is_the_single_head() -> None:
    config = Config("alembic.ini")
    scripts = ScriptDirectory.from_config(config)
    revision = scripts.get_revision("20260726_0008")

    assert scripts.get_current_head() == "20260726_0008"
    assert revision is not None
    assert revision.down_revision == "20260725_0007"
